import { Direction, KeyboardDelegate, Node, Collection, AriaLabelingProps, DOMProps } from "@react-types/shared";
...
export function useGridSelectionAnnouncement<T>(props: UseGridSelectionAnnouncementProps, state: GridSelectionState<T>): void;
